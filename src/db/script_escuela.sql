...
CREATE TABLE "enrollment" (
  ...
  "studentID" bigint,
  "sectionID" bigint, 
  "academicPeriodID" bigint, -- Relaciona la matrícula directamente a un período académico
...
ALTER TABLE "enrollment" ADD FOREIGN KEY ("academicPeriodID") REFERENCES "academic_period" ("id"); -- NUEVA FK
